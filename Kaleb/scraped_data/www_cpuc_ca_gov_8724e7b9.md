--- SOURCE: https://www.cpuc.ca.gov/proceedings-and-rulemaking/alternative-dispute-resolution/what-happens-during-an-alternative-dispute-resolution ---

[Skip to Main Content](https://www.cpuc.ca.gov/proceedings-and-rulemaking/alternative-dispute-resolution/what-happens-during-an-alternative-dispute-resolution#main-content)
[ CA.gov ](http://www.ca.gov)
[Share via Facebook](https://www.cpuc.ca.gov/proceedings-and-rulemaking/alternative-dispute-resolution/what-happens-during-an-alternative-dispute-resolution) [Share via Twitter](https://www.cpuc.ca.gov/proceedings-and-rulemaking/alternative-dispute-resolution/what-happens-during-an-alternative-dispute-resolution) [Share via LinkedIn](https://www.cpuc.ca.gov/proceedings-and-rulemaking/alternative-dispute-resolution/what-happens-during-an-alternative-dispute-resolution) Share via Email
...
SearchLoading
  ...
  4. [What Happens During an Alternative Dispute Resolution](https://www.cpuc.ca.gov/proceedings-and-rulemaking/alternative-dispute-resolution/what-happens-during-an-alternative-dispute-resolution)


#  What Happens During an Alternative Dispute Resolution?
Each dispute is unique—and so is the ADR process used to try resolve the conflict. 
**T he following describes the typical steps in ADR:**
**Request for ADR:**
  * The Assigned ALJ in a formal proceeding will likely discuss ADR with the parties at the first prehearing conference.
  * Parties may also request ADR by filing out an electronic ADR request by following this [LINK](https://ia.cpuc.ca.gov/form/page.aspx?id=27).
  * In addition, parties my contact the Assigned ALJ or the ADR Coordinator at: adr_program@cpuc.ca.gov. Please include your name, telephone number, e-mail address, the formal proceeding number (if any), and a brief description of the dispute.


**The ADR Coordinator suggests process & offers neutral(s): ** After receiving a request, the ADR Coordinator will evaluate the ADR request. If ADR appears suitable, the ADR Coordinator will determine which ALJ neutrals may be available. The parties will have a limited time opportunity to disqualify the proposed ADR neutral for a "good cause" reason and request another neutral. In complex cases, more than one ADR neutral may be offered, thereby allowing the parties to agree on one of the neutrals. Early neutral evaluations may use a panel of up to three ALJ neutrals.  
  
**Selected neutral contacts parties:** After being selected, the ALJ neutral will contact all the parties who have agreed to participate in ADR. The ALJ neutral will discuss the ADR process, confidentiality, and the time and place for the first ADR session. The ALJ neutral will also distribute a set of questions to help participants prepare for the ADR and a standard confidentiality agreement to be executed by all participants at or in advance of the first ADR session.  
  
**Preparation for session:** The ALJ neutral may require the parties to do some work in preparation for ADR, such as preparing a summary of the dispute. The ADR neutral may require the presence of party representatives who have authority to commit to a settlement. Use this [LINK](https://www.cpuc.ca.gov/proceedings-and-rulemaking/alternative-dispute-resolution/preparing-for-adr "LINK") to access a set of ADR Preparation Questions that may help you prepare for the ADR. If the parties agreed and opted for an Early Neutral Evaluation (ENE), the ALJ neutral will provide detailed instructions on how to prepare.  
...
[Flex Alert](https://www.flexalert.org/)
  * [Back to Top](https://www.cpuc.ca.gov/proceedings-and-rulemaking/alternative-dispute-resolution/what-happens-during-an-alternative-dispute-resolution#skip-to-content)

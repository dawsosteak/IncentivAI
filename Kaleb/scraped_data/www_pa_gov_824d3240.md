--- SOURCE: https://www.pa.gov/agencies/health/bureaus-and-offices/operational-excellence-opex ---
...
[ Skip to agency navigation ](https://www.pa.gov/agencies/health/bureaus-and-offices/operational-excellence-opex#agencynav)
[ Skip to main content ](https://www.pa.gov/agencies/health/bureaus-and-offices/operational-excellence-opex#content)
...
The Office of Operational Excellence (OpEx) helps the Department of Health work better for you. We do this by:
**Planning for the future:** We create long-term plans to improve health in Pennsylvania.
**Improving quality:** We find ways to make our work better and more efficient. We foster a culture of quality.
**Ensuring fairness:** We work to make sure everyone in Pennsylvania has a fair chance to be healthy.
OpEx has three distinct teams:
  * **Health Plans Development** : Coordinates the State Health Assessment (SHA), the State Health Improvement Plan (SHIP), the Department’s Strategic Plan, and Public Health Accreditation
  * **Quality Improvement and Performance Management** : Focuses on finding smarter, faster, and more effective ways to deliver essential public health services across Pennsylvania. Learn more about Quality Improvement, Performance Management, and Performance Measures below.
  * **Office of Health Equity** : Leads the department's health equity efforts, working to ensure everyone has a fair chance to be healthy.


###  Quality Improvement
Creates and carries out the Department’s plan to improve quality; leads and keeps track of quality improvement projects; analyzes how things are done and finds ways to make processes more efficient and effective; provides education and training to staff.
###  Performance Management
To make a difference, we need clear goals. We help programs set targets, track progress, and share results that highlight the impact DOH programs have across the state.
###  Performance Measures
We work closely with different DOH programs to report results. Key performance metrics are published in the [Governor’s Executive Budget Book](https://data.pa.gov/stories/s/vpz8-2vuv) for transparency and accountability.
###  Public Health Accreditation
Directs the Department's efforts to achieve and maintain accreditation through the Public Health Accreditation Board (PHAB); this initiative involves coordinating multiple work groups and work streams to demonstrate how the Department's work aligns with national standards and measures for delivering data-driven, evidence-based public health services to the public.
###  Health Planning
Working through the [Healthy Pennsylvania Partnership](https://www.pa.gov/agencies/health/about-us/health-plans-development/hpp), the [Health Plans Development unit](https://www.pa.gov/agencies/health/about-us/health-plans-development) directs the development, review, and implementation of health plans, including the [State Health Assessment (SHA)](https://www.pa.gov/agencies/health/about-us/health-plans-development/state-health-assessment) and the [State Health Improvement Plan (SHIP)](https://www.pa.gov/agencies/health/about-us/health-plans-development/state-health-improvement-plan), in conjunction with local, regional, state, and/or federal health planning, as well as other bureaus and offices across the Department of Health. Develops proposed strategies for the implementation of the SHIP and implements the plan where direct responsibility is held and promotes its implementation by others, including coordination with state government and non-governmental agencies.
###  Workforce Development
Assists with facilitation of the department's Workforce Development Plan in conjunction with Human Resources and the Deputy Secretary of Administration, to ensure accreditation standards are understood and followed.
###  Strategic Planning
Directs the department's [strategic plan](https://www.pa.gov/agencies/health/about-us/health-plans-development/strategic-plan), and its process, including managing aspects of stakeholder engagement; assessment; goal, objective, key performance metrics, and vision and mission setting; development of strategies and action plans; writing; publishing; and ongoing monitoring of the Plan in the Performance Management System.
###  Health Equity
Directs the department's [health equity efforts](https://www.pa.gov/agencies/health/bureaus-and-offices/health-equity) to provide leadership to increase public awareness of health disparities in Pennsylvania; advocate for the development of programs to address health disparities; work with policy makers, insurers, health care providers and communities to implement policies and programs that result in a measurable and sustained improvement in health status of underserved and disparate populations; collaborate with state agencies, academic institutions, community based organizations, health partners, providers and others in the public and private sectors to eliminate health disparities in Pennsylvania.
## Contact Us  

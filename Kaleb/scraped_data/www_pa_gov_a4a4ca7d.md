--- SOURCE: https://www.pa.gov/agencies/health/healthcare-and-public-health-professionals/evitals/faqs ---
...
[ Skip to agency navigation ](https://www.pa.gov/agencies/health/healthcare-and-public-health-professionals/evitals/faqs#agencynav)
[ Skip to main content ](https://www.pa.gov/agencies/health/healthcare-and-public-health-professionals/evitals/faqs#content)
...
##  [Department of Health](https://www.pa.gov/agencies/health)
  ...
  * [Dashboards ](https://www.pa.gov/agencies/health/dashboards)
  ...
  5. eVitals Onboarding FAQs


# eVitals Onboarding FAQs
## **My Facility Administrator Access is “Pending”.**
  ...
  * Verify your facility registered with Keystone Key (aka “IDM”). [All facilities that registered with IDM are listed here](https://view.officeapps.live.com/op/view.aspx?src=https%3A%2F%2Fwww.pa.gov%2Fcontent%2Fdam%2Fcopapwp-pagov%2Fen%2Fhealth%2Fdocuments%2Ftopics%2Fdocuments%2Freporting-registries%2FRegistered%2520Facilities.xlsx&wdOrigin=BROWSELINK).
  * If your facility is not listed _EXACTLY_ (_must be an exact match_) as shown, an authorized representative of the facility must complete the [eVitals Facility Registration Form](https://forms.office.com/g/uKpWhhP4gy).
  * **_IMPORTANT: Your facility MUST be on this list! Even if you found it in eVitals already, if its not on this list that means it hasn’t been linked across through IDM properly and therefore is fully registered. YOUR FACILITY MUST BE REGISTERED!_**
...
![evitals facility search](https://s7d9.scene7.com/is/image/statepa/evitals%20facility%20search?ts=1735834835690&dpr=off)
## **I am the Facility Administrator. What do I need to complete?**
Follow steps 2, 4, and 5 in the [eVitals Sign Up | Department of Health | Commonwealth of Pennsylvania](https://www.pa.gov/agencies/health/healthcare-and-public-health-professionals/evitals/evitals-sign-up). You must be the listed facility Administrator on the original facility onboarding form.
...
## **I am a Facility Admin but I am unable to perform any other functions.**
  ...
  * You need to perform the following as per your Facility Administrator Training: 
    * Login to eVitals and enter the facility you need additional permissions for. _(If you only have one facility you will be on page with Preferred Queues)._
...
## **I report deaths for multiple facilities, but not all of them are in my list.**
  1. Log into eVitals.
  2. Navigate to the **Main** category in the navigation menu.
  3. Select **New Facility Request**.
  4. Click the **Look Up…** button to open the facility look up window.
  5. Enter part of the facility they need to access between the wildcard character like in the screenshot and click the Search button.
  6. Locate the facility in the results and click **Select** to add it to their request.
  7. Complete the remaining contact information. Enter the Job Title and Required Role for the Funeral Directors, their email address, and their FD License #.
  8. Click the Add Facility button to add it to the request.
  9. Click the **Save** button. Whomever the facility administrator is will then have to approve the request and add their FH Director job role to their profile so they can create cases, sign cases & amendments, order DCs, etc.


[View screenshots of the steps(opens in a new tab)](https://www.pa.gov/content/dam/copapwp-pagov/en/health/documents/topics/documents/reporting-registries/evitals/Reporting%20deaths%20for%20multiple%20facilities.pdf). 
## **Where can I get online help?**
###  _For Facility Administrators_ :
We are holding Virtual Office Hours through Train PA. Register for the appropriate session.
  * Facility Administrator Pending Access: <https://www.train.org/pa/course/1123937/live-event>
  * Facility Administrator Assigning Roles to Users: <https://www.train.org/pa/course/1123945/live-event>
  * Facility Administrator Assigned Incorrect Job Role: <https://www.train.org/pa/course/1123946/live-event>
  * Facility Administrator Keystone ID Password Issues: <https://www.train.org/pa/course/1123939/live-event>
...
If you have case-level questions, refer to the user training guides in under the “Resources” tab on these Train PA courses:
  * For Funeral Homes: <https://www.train.org/a/course/1122399/documents/39749/content/>
  * For MEs / Coroners: <https://www.train.org/a/course/1122402/documents/39752/content/>
  * For Medical Facilities: <https://www.train.org/a/course/1122400/documents/39751/content/>


[eVitals Sign Up | Department of Health | Commonwealth of Pennsylvania](https://www.pa.gov/agencies/health/healthcare-and-public-health-professionals/evitals/evitals-sign-up)
...
Loading ...
![Cancel](https://siteintercept.qualtrics.com/WRSiteInterceptEngine/../WRQualtricsShared/Graphics/siteintercept/remove_screen_capture.png)![](https://siteintercept.qualtrics.com/WRSiteInterceptEngine/../WRQualtricsShared/Graphics/siteintercept/building_preview.gif)
Building Preview ...


--- EMBEDDED FILE CONTENT: https://www.pa.gov/content/dam/copapwp-pagov/en/health/documents/topics/documents/reporting-registries/evitals/Reporting%20deaths%20for%20multiple%20facilities.pdf ---

## Reporting Deaths for Multiple Facilities
1. Log into eVitals. 2. Navigate to the Main category in the navigation menu.
* * *
3. Select New Facility Request.
* * *
4. Click the Look Up… button to open the facility look up window.
...
6. Locate the facility in the results and click Select to add it to their request.
* * *
7. Complete the remaining contact information. Enter the Job Title and Required Role for the Funeral Directors, their email address, and their FD License #. 8. Click the Add Facility button to add it to the request.
* * *
9. Click the Save button. Whomever the facility administrator is will then have to approve the request and add their FH Director job role to their profile so they can create cases, sign cases & amendments, order DCs, etc.
* * *

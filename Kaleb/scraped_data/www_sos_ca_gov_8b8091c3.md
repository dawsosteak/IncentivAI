--- SOURCE: https://www.sos.ca.gov/elections/voting-resources/audio-order-form ---

  * [Skip to Main Content](https://www.sos.ca.gov/elections/voting-resources/audio-order-form#main)
  * [Skip to Footer](https://www.sos.ca.gov/elections/voting-resources/audio-order-form#footer)
...
# Audio Order Form
The Secretary of State provides the Official Voter Information Guide in a audio format in English, Spanish, Chinese, Hindi, Japanese, Khmer, Korean, Tagalog, Thai, and Vietnamese.
To order the audio version of the Voter Information Guide on CD, please complete the information in the form and click the "Submit" button.
...
Send an Audio CD Voter Information Guide (VIG) for the following election(s). Check all that apply:
June 2, 2026, Primary Election
All Future Statewide Elections
  

Audio Order Form
Specify Language Preference and Quantity below:
English:
Spanish:
Chinese:
Hindi:
...
[Top of Page](https://www.sos.ca.gov/elections/voting-resources/audio-order-form#top)
|   
---|---

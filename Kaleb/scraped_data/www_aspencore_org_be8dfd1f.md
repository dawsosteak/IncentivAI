--- SOURCE: https://www.aspencore.org/coal-basin-methane-project ---

![](https://www.aspencore.org/coal-basin-methane-project)Use the up and down arrows to select a result. Press enter to go to the selected search result. Touch device users can use touch and swipe gestures.
...
[![A yellow arrow and a yellow circle on a white background.](https://lirp.cdn-website.com/06c12080/dms3rep/multi/opt/NEW-2023_CORE-Logo-Type-1.1--282-29-1920w.png)](https://www.aspencore.org/)
  * [ About ](https://www.aspencore.org/about)
    ...
    * [ Partnerships ](https://www.aspencore.org/coal-basin-methane-project)
    ...
    * [ Newsletters & Blogs ](https://www.aspencore.org/coal-basin-methane-project)
  ...
  * [ Rebates & Grants ](https://www.aspencore.org/coal-basin-methane-project)
  ...
  * [ Services & Resources ](https://www.aspencore.org/coal-basin-methane-project)
    ...
    * [ Building Performance Programs ](https://www.aspencore.org/coal-basin-methane-project)
  ...
  * [ Get Involved ](https://www.aspencore.org/coal-basin-methane-project)
    * [ Upcoming Events ](https://www.aspencore.org/upcoming-events)
    * [ Green Expo ](https://www.aspencore.org/green-expo)
  * [ Donate ](https://www.aspencore.org/coal-basin-methane-project)
...
[ Project History ](https://www.aspencore.org/coal-basin-methane-project#ProjectHistory)
...
CORE is collaborating with [Delta Brick & Climate Co.](https://www.deltabrick.com/) to gain more understanding of methane emissions escaping from the mines and explore effective solutions to tackle this challenge. 
...
![A man is giving a presentation in front of a large screen.](https://lirp.cdn-website.com/06c12080/dms3rep/multi/opt/Core-Coal-Basin.10.28.22.242-1920w.jpg)
In the spring of 2024, we hosted presentations in Redstone and Basalt, Colorado, to share our findings from the data collection that took place at Coal Basin in 2023, as well as our recommendations for mitigation moving forward. The feedback collected from our outreach efforts helped us frame our application to the [US Forest Service](https://www.fs.usda.gov/r02/whiteriver/projects/archive/64062) to request approval to move forward with mitigation efforts. 
  

Click the button below to download our presentation slides and scroll down to learn more.
[ DOWNLOAD PRESENTATION SLIDES ](https://irp.cdn-website.com/06c12080/files/uploaded/Coal_Basin_April30_2024.pdf)
##  Methane 101  
...
While methane remains in the atmosphere for a shorter period compared to carbon dioxide, it is far more effective at trapping heat, which leads to global warming and climate change. According to the [EPA](https://www.epa.gov/ghgemissions/understanding-global-warming-potentials), methane is 84 times more potent than carbon dioxide over a 20-year period.  
...
In 2023, methane release data was collected from various sites throughout Coal Basin. From our research, we estimate that 1,950 metric tons of methane are escaping from Coal Basin each year. That’s equivalent to 36,456 gasoline-powered passenger vehicles driven for one year or equivalent to nearly 30% of all other greenhouse gas emissions being released in Pitkin County combined.
...
*Calculated based on the[2023 Pitkin County Region Comprehensive Greenhouse Gas Emissions Report](https://www.aspencore.org/emissions-inventory) & the [EPA Greenhouse Gases Equivalencies Calculator.](https://www.epa.gov/energy/greenhouse-gas-equivalencies-calculator)  

##  Project History  

  * ###### September 2024 - Present | USFS Application Review
CORE is awaiting final review of its proposal from the US Forest Service.
...
![A group of people are standing around a map in a field.](https://lirp.cdn-website.com/06c12080/dms3rep/multi/opt/coal-basin-climate-project-f03eb2ce-1920w.jpeg)
##  Taking Action  
...
The Coal Basin project team estimates that we can mitigate 20% of the methane emissions being released from Coal Basin through a few different techniques. We believe that these efforts will bring the highest return on investment with the least amount of impact on the environment and community. Our recommendations include: 
  ...
  * We submitted our proposal for a permit request to the [US Forest Service.](https://www.fs.usda.gov/r02/whiteriver/projects/archive/64062) The proposal included a request to capture and mitigate methane at Coal Basin and an outline of our intended goals and efforts based on data collection and researched mitigation options.  
...
####  You can support the project and take action on climate change by:  
  ...
  * Sharing your voice. Reach out to CORE, local elected officials, and your peer networks like local climate organizations with your comments. If the US Forest Service approves our proposal, the public may be asked to [share its thoughts with them](https://www.fs.usda.gov/r02/whiteriver/projects/archive/64062), as well.
  * [Donate to CORE](https://www.aspencore.org/donate). We estimate that the project at Coal Basin will cost more than $6 million to implement and maintain. Support the project with a financial contribution.
  * Take action in your community. CORE is taking bold steps to reduce greenhouse gas emissions in the Roaring Fork Valley. [Contact us](https://www.aspencore.org/energy-concierge) and we’ll help you find easy solutions to reduce energy consumption close to home.  
...
In 2021, CORE was connected to the research that [Delta Brick & Climate Company](https://www.deltabrick.com/) was doing to evaluate the amount of methane escaping the abandoned coal mines in Redstone, Colorado, and the climate impacts of those emissions. Two reports, one from the EPA and one from the Colorado Energy Office, estimated that the mines could be emitting significant amounts of methane. 
...
The equipment produces noise from its blower, and the noise would be minimized with noise-dampening systems. The RTO is about the size of a shipping container (30 feet x 10 feet x 20 feet) and would be supported by a concrete foundation. 
...
![CORE staff member conducting a home energy assessment in Aspen, demonstrating their hands-on approach to climate solutions.](https://lirp.cdn-website.com/06c12080/dms3rep/multi/opt/DeltaBrick-ClimateCompany_CoreAspen_CoalBasin_MethaneCapture_ImpactMediaLab_-26--281-29-4ec56c68-1920w.jpg)
![CORE staff member conducting a home energy assessment in Aspen, demonstrating their hands-on approach to climate solutions.](https://lirp.cdn-website.com/06c12080/dms3rep/multi/opt/20240326_181920--281-29-096abd34-1920w.jpg)
...
Mitigating methane emissions at Coal Basin would be one of the most significant opportunities for greenhouse gas reduction in our communities. We estimate that 1,950 metric tons of methane are escaping from Coal Basin each year. That’s equivalent to 36,456 gasoline-powered passenger vehicles driven for one year or nearly 9% of emissions in Pitkin County.
...
Yes. Depending on the final selection of equipment for the site, it could be done. Delivering the equipment by helicopter, however, would significantly increase the installation and project costs. Opening the road would still be necessary to maintain and troubleshoot the equipment. 
...
The leading organization coordinating research and data collection at Coal Basin. [Delta Brick](https://www.deltabrick.com/) will report their findings to our funders and community throughout the course of the project. 
###### US Department of Energy
A key funder and supporter of the Coal Basin Methane Project. The [US Department of Energy](https://www.energy.gov/) oversees the [Methane Emissions Reduction Program](https://www.energy.gov/fecm/articles/epa-and-doe-announce-intent-fund-efforts-reduce-methane-emissions-oil-and-gas-sector#:~:text=The%20Methane%20Emissions%20Reduction%20Program%2C%20created%20by%20the%20Inflation%20Reduction,benefit%20of%20reducing%20non%2DGHG).
###### Atlantic Aviation
...
[![The logo for atlantic aviation is blue and white](https://lirp.cdn-website.com/06c12080/dms3rep/multi/opt/admin-ajax-1920w-1920w.webp)](https://www.aspencore.org/)
...
--- EMBEDDED FILE CONTENT: https://irp.cdn-website.com/06c12080/files/uploaded/Coal_Basin_April30_2024.pdf ---

## Coal Basin Community Presentation
April 4th, 2024 Presented by Christopher Caskey, Delta Brick & Climate Company
* * *
## Key Study Findings
●All data points to action ●1,950 metric tons of methane escaping from Coal Basin annually ●Mitigation of 185-400 metric tons of methane per year likely ●Regenerative thermal oxidizer at Dutch Creek #1 recommended as best trade off to minimize disturbance and maximize mitigation ●Adding mitigation at Dutch Creek #2 warranted ●Bioremediation at LS Wood recommended as a low-downside experiment
* * *
●Methane (CH4) is a potent greenhouse gas with a global warming potential that is 86 times more potent than Carbon Dioxide (CO2) over a 20-year period ●1 metric ton of CH4 = 86 metric tons of CO2 equivalent (CO2e) = 189,630 lbs CO2e Math Review
* * *
Local Math ●1,950 metric tons of CH4 emissions = 167,700 metric tons of CO2e ○Equivalent to 33% of all other emissions sources in Pitkin County combined ○36,456 gasoline-powered passenger vehicles driven for one year ●400 metric tons of CH4 mitigation potential = 34,400 metric tons of CO2e ○Equivalent to 8,187 gasoline-powered passenger vehicles driven for one year ○CORE’s annual mitigation work in building related energy use is equivalent to 1,500 metric tons CO2e
* * *
## Orientation to Coal Basin
Volcanic intrusion Coal seams Gas-bearing shales Wildly not-to-scale
* * *
Post-Mining Geometry Mines Methane and air escaping Concrete header of a portal to the Dutch Creek #1 Mine. Access tunnel Air intrusion
* * *
Aircraft Results ●Mass balance: snapshots of emissions at the time ●4 flights total ●112, 125, 488, and 167 kg/h observed ●Avg 223 kg/h ●= 1,953 metric tons of CH4 per year
* * *
Aircraft Results ●Raster flight to help locate leaks ●3 flights total ●Indicated methane was leaking high in the complex ●Methane blowing in from other areas also picked up by airplane
* * *
## SummaryAircraft Results
●1,950 metric tons CH4 per year leaking from the mine complex ●Known leaks sites represented in the raster flight data ●Unknown leaks present high in the complex ○Dutch Creek #2 mine is a possible culprit
* * *
On-the-Ground Work ●Collected data from more than 20 sites from June to October ○Processed data from all sites we could quantify ○Bottom-up technique ○Expect sum of sites to be well below top-down measurements
* * *
●Modeled leaks at Bowie as a function of temperature and pressure ○Modeling by Methane Signals Corp ○Robust emissions dataset at Bowie > 6 months ○Using weather data from national satellite archives ●Applied Bowie Model to Coal Basin ○1-4 weeks field data at each leak site ●Separate dataset collected and analyzed by Colorado State University shows similar results Data Analysis
* * *
## SummaryOn-the-Ground Work
●Quantified a minority of possible leaks ●185-400 metric tons of methane per year identified at Dutch Creek #1 ●Data limited for Dutch Creek #2 but what we know suggests further exploration and mitigation is warranted ●Peer review of data concurs (Methane Signals Corp.)
* * *
## Menu of Options
More methane mitigated, less negative impact Less methane mitigated, more negative impact RTO at DC #1 main portalsDrill into DC #2 Seal at DC #1 waterfall portalSeal at DC #2 north or south portalsPortable flare at LS WoodWater manufacturing Drill and flare at Bear Creek or Coal Basin mineDrill and flare at LS WoodBioremediation at LS WoodBioremediation at DC #1 waterfall
* * *
## Case Study: Dutch Creek #1
●Impact ~10 acres including 2.85 miles of road ●Approximately $4 million capital expenses ○Plus $250,000 operating costs annually ●Potential to destroy more than 185-400 metric tons of methane per year 1.9 kg/h 12 kg/h 21.6 kg/h 3.2 kg/h
* * *
## Proposed Mitigation Option at
Dutch Creek #1Regenerative Thermal Oxidizer (RTO) Proven technology for this type of application ●Footprint: 17’ X 24’ ●Noise level: 80-85 decibels without dampening ●RTO emissions = 114 mt of CO2e/yr (electricity and propane) ●Manufacturer assures us cold and elevation are not a problem ●Equipment life: 20 years
* * *
## Case Study: Dutch Creek #2
●We hypothesize a significant amount of methane in Dutch Creek #2 Mine based on aircraft data and mine maps ●Drilling into mine from near RTO would cause minimal additional disturbance ●Approximately $500k capital expenses with minimal additional operational expenses ●Unknown quantity ○Won’t know for sure until we drill Mines Methane and air escaping Access tunnel Air intrusion
* * *
## Proposed Mitigation Option at
Dutch Creek #2 Mines Tie DC #2 into RTO system Main Portal, 21.6 kg/h New borehole Fan Shaft, 1.9 kg/h RTO Drill Site Flat Rocks, 12 kg/h
* * *
## Mitigating Methane at Dutch
Creek #1 & #2 ●Predict 500 metric tons of methane captured per year ○400 from Dutch Creek #1 and 100 from Dutch Creek #2 ●Net benefit of 41,000 metric tons CO2e per year ●Cost $4.5 million capital cost plus $250,000 per year operating costs ●Approximately 400,000 metric tons CO2e mitigated over 10 years ○Total cost: $7 million ○$17.50 per metric ton CO2e ○Compared to buying an EV (with solar to charge it) = $1,087 per metric ton CO2e
* * *
## Water Manufacturing at Dutch
Creek #1 ●Destruction of methane creates new source of water ○CH4 + 2 O2 → CO2 + 2 H2O ●Can be used to improve reclamation of mine site ●Can be applied towards low-priority residential wells in the Crystal River Valley
* * *
Challenges ●Permitting and approval ●Electricity at the site ●Road maintenance
* * *
Experimental Opportunity: Bioremediation ●Use locally-occurring methane-eating bacteria to remediate small leaks ●Route leaks through bioreactor ○No pumps on mine void ○Maybe a small fan to circulate through bioreactor ●Bring equipment in with horses ●Candidate siteLS Wood mine
* * *
## Impacts & Community Concerns
●Wildlife○Site disturbance after elk calving ○After construction is complete, project is quiet and does not require much visitation (monthly maintenance) ●Opening the road for installation and maintenance ●Watershed/Erosion○Use best practices on road ○Basin is erosive and the stream is adapted to high sediment loads ○Use manufactured water to improve reclamation on mine-impacted sites ●Recreation ○Minor traffic through bike park ●All impacts will be analyzed by USFS as part of their NEPA process
* * *
Big Takeaways ●1,950 metric tons of methane per year is a reasonable estimate for total flux ●We know where ~20% of that is leaking out ●Dutch Creek #1 has the highest mitigation potential at 400 metric tons CH4 per year ○Water manufacturing possible with RTO ●Mitigation at Dutch Creek #2 could be added with minimal additional disturbance and cost ●LS Wood could be a site to test bioremediation
* * *
Next Steps ●Continue to seek community inputMeeting in Redstone, April 4 ●Submit application to USFS late Spring 2024 ●Pursue additional funding opportunities contingent on approval 2024 ●Environmental work (NEPA) through 2025 ●Potential for remediation work to begin in 2026
* * *
Thank You ●US Forest Service ●CORE ●US Department of Energy ●Senators Bennet & Hickenlooper ●Volunteers ●Coal Basin Ranch Bike Park ●Pitkin County ●Coal Basin Advisory Committee ●Colorado State University ●Atlantic Aviation
* * *

--- SOURCE: https://www.pa.gov/agencies/health/programs/vital-records/death-certificates ---
...
[ Skip to agency navigation ](https://www.pa.gov/agencies/health/programs/vital-records/death-certificates#agencynav)
[ Skip to main content ](https://www.pa.gov/agencies/health/programs/vital-records/death-certificates#content)
...
You will receive a certified "_No Record Certification of Death"_ if you request a certificate and we cannot identify or find a record using the information you provided. Therefore, please provide as much information as possible to assist us in locating the requested death record.
**_For death certificates from other states:_** If you need a certificate for someone that died in another state, see the [National Center for Health Statistics](http://www.cdc.gov/nchs/w2w.htm) website for contact information.
###  What are the types of death certificates?
...
**For walk-in services:** Please see our [Public Office](https://www.pa.gov/agencies/health/programs/vital-records/public-offices) page for office locations and hours of operation.
**For mail services:** You may complete an [Application for Death Certificate](https://www.pa.gov/content/dam/copapwp-pagov/en/health/documents/topics/documents/certificates-and-records/Application%20for%20a%20Death%20Certificate.pdf) and mail it to the address listed below. All certificates are mailed using First Class Mail®. 
...
**You must complete the following requirements to receive a death certificate.**
  * You must complete an [Application for Death Certificate](https://www.pa.gov/content/dam/copapwp-pagov/en/health/documents/topics/documents/certificates-and-records/Application%20for%20a%20Death%20Certificate.pdf).
  * You must show [valid identification](https://www.pa.gov/agencies/health/programs/vital-records/acceptable-id).
...
**If you need a death certificate quickly, make your request in person at one of our** **six** **[Vital Records Branch Offices](https://www.pa.gov/agencies/health/programs/vital-records/public-offices)** **or online at** **[mycertificates.health.pa.gov](https://mycertificates.health.pa.gov/).**
See our [Processing Times](https://www.pa.gov/agencies/health/programs/vital-records/processing-times) for current processing times for applications placed online, by telephone or by mail.
[Processing times](https://www.pa.gov/agencies/health/programs/vital-records/processing-times) are based upon application receipt date and do not include delivery time. It may take longer if we need to resolve application issues, for genealogical requests, or if your application involves a subpoena, court order, or power of attorney. Requests for changes to a death record may also require additional processing.
###  What is the cost for a death certificate?
...
View [acceptable forms of identification](https://www.pa.gov/agencies/health/programs/vital-records/acceptable-id).
###  How do I apply for a multi-year search for a death record? 
Learn how to [apply for a multi-year search for a death record](https://www.pa.gov/agencies/health/programs/vital-records/multi-year-searches).
...
If you have questions about Pennsylvania death certificates, contact the Division of Vital Records using one of the following methods:
  * [Online contact form](https://apps.health.pa.gov/dohforms/ContactUsBirthAndDeath.aspx) – Allow two to three business days for a response.

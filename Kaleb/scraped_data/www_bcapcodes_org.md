...
[Level One](https://bcapcodes.org/energy-code-reform/#lvl1) | [Level Two](https://bcapcodes.org/energy-code-reform/#lvl2) | [Level Three](https://bcapcodes.org/energy-code-reform/#lvl3) | [Level Four](https://bcapcodes.org/energy-code-reform/#lvl4)
#### Level One: No Codes or Outdated Codes
_Updating building energy codes to the most recent IECC or ASHRAE 90.1 standards – and requiring that any future updates be adopted within one year of these standards’ publication – ensures that new construction uses less energy, contributes fewer pollutants to our environment, and improves comfort and productivity._
* * *
...
States with no energy code in place should initiate a code adoption process to ensure the most current national model energy code is adopted.
  * [Alabama House Bill 242](https://bcapcodes.org/wp-content/uploads/2016/01/Level_I_AL_HB242_No_Code.pdf) was an example of legislation introduced in a state with (at that time) no existing mandatory statewide commercial code.


States that have energy codes in place should consider updating to the most current national model energy code.
  * [Louisiana House Bill 743](https://bcapcodes.org/wp-content/uploads/2016/01/Level_I_LA_HB743_Updating_Code.pdf) was an example of updating the code.
  * [North Carolina House Bill 586](http://www.ncleg.net/Sessions/2007/Bills/House/PDF/H586v1.pdf) (2007) was an example of adoption of the International Building Code (IBC) with a specific reference to the IECC.
...
A state can also tie adoption or revision to the publication date of an energy standard or model energy code to ensure automatic updates by incorporating the following language, e.g. “this regulation shall take effect one month from publication of the adopted model energy code.”
  * [Massachusetts House Bill 3221](https://bcapcodes.org/wp-content/uploads/2016/01/Level_I_MA_HB3221_Automatic_Update.pdf) is an example of automatic code revision cycle.
  * [Louisiana House Bill 743](https://bcapcodes.org/wp-content/uploads/2016/01/Level_I_LA_HB743_Updating_Code.pdf) is an example of automatic code revision cycle.
...
Several states have enacted legislation that encourages the construction of high performance schools.
  * State-funded school construction projects greater than 5,000 square feet are required to incorporate high-performance features into their school design and construction. State legislation gives Washington schools a choice between Leadership in Energy and Environmental Design (LEED) or the Washington State K–12 school-specific standard called [Washington Sustainable Schools Protocol (WSSP)](http://www.k12.wa.us/SchFacilities/Programs/HighPerformanceSchoolBuildings.aspx).
  * School construction regulations and policies in [Vermont](http://www.neep.org/initiatives/energy-efficient-buildings/high-performance-schools/vermont) are directly tied to state funding.
  * The 82nd Texas Legislature approved [Senate Bill 1557](http://texashpsc.org/wp-content/uploads/2013/03/sb1557.pdf) in 2011, calling for the commissioner of education to select schools for the Texas High Performance Schools Consortium. After an application process, 23 Texas school districts were selected in September 2012 by Commissioner Michael Williams to comprise the Consortium.
  * [Designing and Constructing High Performance Schools for a Healthy School Environment | EPA](http://www.epa.gov/schools-healthy-buildings/designing-and-constructing-high-performance-schools-healthy-school)
  * [Energy Design Guidelines for High Performance Schools | NREL](http://www.nrel.gov/docs/fy02osti/29105.pdf)
  * [National Best Practices Manual for Building High Performance Schools | DOE](http://apps1.eere.energy.gov/buildings/publications/pdfs/energysmartschools/nationalbestpracticesmanual31545.pdf)
...
* * *
[Back to top](https://bcapcodes.org/energy-code-reform/#top)
#### Level Three: Improve the National Model Codes
...
* * *
[Back to top](https://bcapcodes.org/energy-code-reform/#top)
#### Level Four: Enact Innovative Legislation
_After a code is adopted, the code’s success or failure is impacted by the local building industry’s ability and willingness to comply with the new code requirements. Through the use of innovative legislation tied to the energy codes, some states and cities have been able to further encourage and improve compliance._
* * *
...
States can requires new residential buyers to receive information on how home meets, falls below, or exceeds the national model code.
  * Kansas [House Bill 2036](http://www.kansas.gov/government/legislative/sessionlaws/2007/chap100.pdf) established the 2006 IECC as the state commercial code and updated the Kansas Energy Efficiency Disclosure form so that the form provides information on whether a residence meets the energy efficiency standards of the 2006 IECC.
...
![](https://bcapcodes.org/energy-code-reform/)
  * Follow BCAP On Social Media
  * [![facebook](https://bcapcodes.org/energy-code-reform/)](https://www.facebook.com/buildingcodesassistanceproject/)![](https://bcapcodes.org/energy-code-reform/)[![linkedin](https://bcapcodes.org/energy-code-reform/)](https://www.linkedin.com/company/building-codes-assistance-project)
...
## Current Codes of Taiwan
Taiwan’s building regulations now integrate **energy efficiency** , **green building certification** , and **net-zero transition goals** under the leadership of the **Ministry of the Interior (MOI)** and the **Bureau of Energy, Ministry of Economic Affairs (MOEA)**.
The country currently enforces two core national energy standards—one for **residential** and one for **non-residential** buildings—supported by the **EEWH Green Building Rating System** , a mandatory or semi-mandatory sustainability standard for large or public projects.
Together, these codes form the backbone of Taiwan’s sustainable-building policy and contribute to its **Net Zero 2050** strategy.
...
* * *
### Key Building Energy Standards in Taiwan
### 1. Non-Residential Building Energy Efficiency Standard
This standard defines performance targets for **building envelope, lighting, and HVAC systems** , expanding beyond its original envelope-only approach from the 1995 version.
  * **Envelope Performance:** Uses an **ENVLOAD** index (envelope load ratio) to calculate annual cooling load based on orientation, glazing, and insulation.
  * **Lighting Power Density (LPD):** Maximum allowable W/m² values are specified by occupancy type.
  * **HVAC Efficiency:** Minimum COP/EER values for air-conditioning systems; variable-speed drives are encouraged.
  * **Compliance Paths:** Designers can choose between **prescriptive** tables or a **performance-based simulation** method.


Latest revision: **2021** (enforced from 2022), aligned with **ASHRAE 90.1:2019** benchmarks for comparable climate zones.
### 2. Residential Building Energy Efficiency Standard
Taiwan’s residential code establishes prescriptive requirements for **roof insulation, external walls, glazing, and window shading**.
  * Roofs and walls must meet specific **thermal transmittance (U-value)** limits by region.
  * Glazing must meet solar-heat-gain coefficient (SHGC) criteria.
  * High-rise residential buildings must include **ventilation and daylighting** design provisions.
  * Compliance can be verified through the **Building Energy Efficiency Certification (BEEC)** process under the Bureau of Energy.


Last updated: **2018** , with revisions under review to incorporate **renewable-energy readiness** and **building envelope performance modeling**.
* * *
### 3. EEWH — Taiwan’s Green Building Rating System
Taiwan pioneered **Asia’s first national green-building system** , known as **EEWH** (Ecology, Energy Saving, Waste Reduction, and Health).  
Administered by the **Architecture and Building Research Institute (ABRI)** under MOI, EEWH rates buildings across nine categories including energy conservation, waste reduction, biodiversity, indoor environmental quality, and CO₂ reduction.
  * Certification levels: **Qualified** , **Bronze** , **Silver** , **Gold** , and **Diamond**.
  * Mandatory for:
    * New **public buildings ≥50,000 m²**
    * Government projects
    * Certain large commercial and residential developments.
  * As of 2024, more than **7,000 projects** have received EEWH certification.
  * A **Zero Carbon Building** pilot program (EEWH-ZCB) is under development to support Taiwan’s **Net-Zero 2050** roadmap.


* * *
### 4. National Energy and Climate Framework
  * **Energy Management Act (amended 2019)** — provides authority for energy conservation requirements across building types.
  * **Greenhouse Gas Reduction and Management Act (2015)** — sets long-term emissions caps, including building sector targets.
  * **Net-Zero Emissions by 2050 Roadmap (2022)** — includes stronger building-efficiency standards, renewable-energy integration, and stricter lifecycle carbon assessment for construction materials.
...
---|---|---  
**1979–1995** | Early insulation codes | Initial envelope-based thermal standards introduced for commercial buildings.  
**1997** | Residential standard | Roof and wall insulation requirements codified.  
**2009** | “Energy Saving Measures for the Built Environment” | Set national efficiency and GHG-reduction goals; encouraged green-building practices.  
**2015–2018** | EEWH expansion | Green building certification scaled nationally; residential energy standard updated.  
**2021–2022** | Non-residential code modernization | HVAC and lighting provisions introduced; performance-based modeling allowed.  
**2023–2025** | Net-Zero integration | Draft revisions add renewable-readiness, embodied-carbon accounting, and life-cycle benchmarks.  
...
In 2009, Taiwan’s [Energy Saving Measures for the Built Environment](http://www.ecct.com.tw/file/userfiles/files/Building_Awareness.pdf) set goals for 2015 for energy efficiency and cutting GHG emissions. It provides building strategies, case studies, and promotes overall building efficiency.
### Compliance and Enforcement
  * **Authority:** Ministry of the Interior (Construction and Planning Agency, CPA) and Bureau of Energy (MOEA).
  * **Permit Stage:** Designers must submit envelope and system calculations or EEWH certification documentation.
  * **Post-construction:** Energy performance validation via testing or commissioning reports for large projects.
  * **Penalties:** Non-compliance can result in rejection of occupancy permits or fines under the Energy Management Act.
...
#### Issue
Heating and cooling account for [39%](https://www.wbdg.org/resources/high-performance-hvac) of the energy used in U.S. commercial buildings. This represents a large opportunity to save energy throughout U.S. buildings. One of the leading cause of energy waste from heating and cooling in commercial buildings is inadequate insulation.
#### Overview

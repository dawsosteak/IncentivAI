--- SOURCE: https://www.sos.ca.gov/administration/public-records-act-requests/other ---

  * [Skip to Main Content](https://www.sos.ca.gov/administration/public-records-act-requests/other#main)
  * [Skip to Footer](https://www.sos.ca.gov/administration/public-records-act-requests/other#footer)
...
# Other
The Secretary of State does NOT have records for the following categories of searches and records:
  * Record search by an individual/name;
  * Record search by real property parcel number or street address;
  * List of registered people or business entities by profession;
  * Body cam footage or surveillance footage from traffic accidents or arrests;
  * Phone transcripts/incident reports from city/county agencies;
  * Procurement records (RFO, RFQ, RFI etc.) for contracts for other agencies;
  * Family/Individual Trusts, Wills, or Power of Attorney documents;
  * Marriage, death, or birth certificates;
  * Child custody/Child Support documents;
  * Communication outside of the Secretary of State;
  * Financial records for other agencies.
...
[Top of Page](https://www.sos.ca.gov/administration/public-records-act-requests/other#top)
|   
---|---

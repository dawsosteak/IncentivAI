--- SOURCE: https://www.pa.gov/agencies/health/programs/immunizations/piers-public-portal ---
...
[ Skip to agency navigation ](https://www.pa.gov/agencies/health/programs/immunizations/piers-public-portal#agencynav)
[ Skip to main content ](https://www.pa.gov/agencies/health/programs/immunizations/piers-public-portal#content)
...
##  [Department of Health](https://www.pa.gov/agencies/health)
  ...
  * [Dashboards ](https://www.pa.gov/agencies/health/dashboards)
  ...
  5. PIERS Public Portal


# PIERS Public Portal
Submit your request for your immunization records through the PIERS Public Portal. 
Looking for your Pennsylvania immunization records? You can access your, or your dependent’s, official immunization record through the secure Pennsylvania Immunization Electronic Registry System (PIERS) Public Portal. 
...
## Instructions for Accessing PIERS
  1. 1
### Login with your Pennsylvania Keystone Login account
A Pennsylvania Keystone Login account is required to access the PIERS Public Portal for an added layer of security. If you do not have a [Pennsylvania Keystone Login account(opens in a new tab)](https://keystonelogin.pa.gov/), you will need to register for one. [Register for an account(opens in a new tab)](https://keystonelogin.pa.gov/).
     * Contact the Keystone Login Help Desk for all questions, concerns, and issues with Keystone Login. The help desk can be reached by phone at 877-328-0995 or by email at KeystoneLoginSupport@randstadusa.com(opens in a new tab).
  2. 2
### Go to the PIERS Public Portal
Go to the [PIERS Public Portal(opens in a new tab)](https://vaccines.health.portal.pa.gov/Home/Login) and enter your Keystone Login username and password.
  3. 3
### Select your relationship
Select your relationship to the patient whose record you are accessing (self or dependent).
  4. 4
### Enter your or your dependent’s information
Enter your or your dependent’s name, date of birth (MM/DD/YYYY) and gender.
Be sure to enter the information exactly how it is documented at your immunization provider (hospital, clinic, pharmacy, etc.). 
     * _Note: Parents cannot search and access their adult (18+) child’s record._
  5. 5
### Choose how you want to get a code
Choose how you want to get a code to access the immunization record (by mobile phone or email). Then enter the phone number or email address that you or your dependent gave to your immunization provider and click ‘Get Access Code.’
     * _The PIERS system gets your information from your health care provider(s). To improve the chances of finding your record, enter the same contact information you gave your provider. What you enter must match what’s in the PIERS system to access the records._
  6. 6
### Enter the Verification Code
Enter the Verification Code in the text box on the next screen and click ‘Verify.’ 
  7. 7
### View the record
View the record or click ‘Download Full Record’ to save or print the Official Immunization Record.
  8. 8
### Close session
When finished viewing and/or saving your record, you can click ‘Close Session’ at the bottom of the page to log out.


## PIERS Public Portal Frequently Asked Questions 
###  What if the PIERS Public Portal says my record can’t be found? 
If your record can’t be found, please complete the [PIERS Immunization Record Update Request Form(opens in a new tab)](https://forms.health.pa.gov/PIERS-Immunization-Record-Update-Request/), and upload proof of identification. The PIERS Helpdesk team will perform a search in PIERS for your record. If a record is found, your demographic information will be updated for you to access your record from the PIERS Public Portal**.**
###  I have a different name/phone number/email address than the one used at my doctor’s office. How do I update this information to view my records? 
Please complete the [PIERS Immunization Record Update Request Form(opens in a new tab)](https://forms.health.pa.gov/PIERS-Immunization-Record-Update-Request/). The PIERS Helpdesk team will perform a search in PIERS for your record. If a record is found, your demographic information will be updated for you to access your record from the PIERS Public Portal.
###  Why can’t I see my childhood immunizations on my record? Why aren’t all my immunizations on my record? 
Your immunization provider may have not reported the vaccine administration. Only pharmacies and Vaccines for Children Program providers are required to report vaccine administrations to PIERS. Reporting to PIERS started in the early 2000s, vaccine records before then have likely not been reported to PIERS.
###  Where can I find my missing immunization records?
...
###  What if I still can’t find my records? 
There is no national database for vaccine records—only the copies you, or your parents, received and those kept by the clinic where you received the vaccine. If you can’t find your vaccination records, talk to your health care provider to determine how best to protect yourself from certain diseases.
###  I live in Philadelphia and receive most of my immunizations in Philadelphia. Why aren’t they on my record from the PIERS Public Portal? 
Immunization providers in all Pennsylvania counties except Philadelphia report to PIERS. Immunization providers in Philadelphia report to [PhilaVax(opens in a new tab)](https://vax.phila.gov/philavax/Login.aspx). Please contact PhilaVax at philavax@phila.gov(opens in a new tab) for questions regarding immunizations received in Philadelphia.
###  I received my immunizations in another state. How do I access those records? 
Please visit the [CDC’s Contacts for IIS Immunization Records website(opens in a new tab)](https://www.cdc.gov/iis/contacts-locate-records/index.html) for more information on how to contact the jurisdiction where you received your immunizations. 
###  How did you get my immunization records? 
Pharmacies and Vaccines for Children Program providers are required to report vaccine administrations to PIERS. In addition, other immunization providers are encouraged to submit vaccine administration data to PIERS on a voluntary basis. 
###  How do I ensure that all of my or, my dependent’s, future vaccination records are available? 
  * Bring your or your child’s vaccination record to every vaccination appointment to avoid missing or repeating shots, and to document new vaccinations.
...
###  How do I know my online records are secure?
...
###  Is there a limit to the number of searches I can do at one time? 
...
###  I’m a legal guardian of an adult over 18. Can I access their vaccination record?
If an adult over 18 is not able to access their record through the PIERS Public Portal, legal guardians will be able to receive their record once an [Authorization for Release of Immunizations Records form(opens in a new tab)](https://forms.health.pa.gov/PIERS-release-of-records/) is completed. Please allow a minimum of 10 business days for fulfillment of your vaccine record request.
###  I have an elderly parent who doesn’t have an email address or mobile phone number to get a code. How do they access their immunization records?
An [Authorization for Release of Immunizations Records form(opens in a new tab)](https://forms.health.pa.gov/PIERS-release-of-records/) can be completed. Please allow a minimum of 10 business days for fulfillment of your vaccine record request.
###  My child’s mother/father and I are divorced. Will both of our email addresses and/or phone numbers work to access our child’s records?

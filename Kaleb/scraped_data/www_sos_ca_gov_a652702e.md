--- SOURCE: https://www.sos.ca.gov/elections/voting-resources/large-print-order-form ---

  * [Skip to Main Content](https://www.sos.ca.gov/elections/voting-resources/large-print-order-form#main)
  * [Skip to Footer](https://www.sos.ca.gov/elections/voting-resources/large-print-order-form#footer)
...
# Large Print Order Form
The Secretary of State provides the Official Voter Information Guide in a large-print format in English, Spanish, Chinese, Hindi, Japanese, Khmer, Korean, Tagalog, Thai, and Vietnamese.
To order the large-print version of the Voter Information Guide, please complete the information in the form and click the "Submit" button.
If you prefer, you may print the form and mail to:
  * Elections Division
  * Secretary of State
...
Name:
Address:
NOTE: large print orders cannot be delivered to a P.O. Box
City:
State:
ZIP Code:
Phone:
...
Send a Large Print Voter Information Guide (VIG) for the following election(s). Check all that apply:
June 2, 2026, Primary Election
All Future Statewide Elections
...
[Top of Page](https://www.sos.ca.gov/elections/voting-resources/large-print-order-form#top)
|   
---|---

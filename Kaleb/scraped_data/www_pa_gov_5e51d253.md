--- SOURCE: https://www.pa.gov/agencies/health/programs/environmental-health/pawss ---
...
[ Skip to agency navigation ](https://www.pa.gov/agencies/health/programs/environmental-health/pawss#agencynav)
[ Skip to main content ](https://www.pa.gov/agencies/health/programs/environmental-health/pawss#content)
...
##  [Department of Health](https://www.pa.gov/agencies/health)
  ...
  * [Dashboards ](https://www.pa.gov/agencies/health/dashboards)
  ...
  5. Pennsylvania Wastewater Surveillance System (PaWSS)


# Pennsylvania Wastewater Surveillance System (PaWSS)
The Pennsylvania Wastewater Surveillance System (PaWSS) works with wastewater treatment plants across the state and with national wastewater surveillance projects to measure viruses or other disease targets in wastewater. This helps us understand disease trends in the community.
...
### **PaWSS Dashboard**
The PaWSS dashboard shows trends of SARS-CoV-2, Influenza A, and RSV found in wastewater samples from locations across Pennsylvania. This information helps us understand how these diseases are spreading within communities. To see data for a specific location, select the location from the list on the left side of the dashboard. The color of the dot on the map shows the latest trend category for that site. For more instructions on how to use the dashboard, select the icon. For more information about the dashboard itself, view the [PaWSS SARS-CoV-2 dashboard FAQs(opens in a new tab)](https://www.pa.gov/content/dam/copapwp-pagov/en/health/documents/topics/documents/environmental-health/WSS%20Dashboard%20FAQ.pdf).
**[View the full size PaWSS dashboard(opens in a new tab)](https://app.powerbigov.us/view?r=eyJrIjoiZWUxOGMyNGEtNTdlZC00YzY0LWE0NDktN2JkNGFlNjUxYmYyIiwidCI6IjQxOGUyODQxLTAxMjgtNGRkNS05YjZjLTQ3ZmM1YTlhMWJkZSJ9)**
...
Information on other wastewater surveillance programs in Pennsylvania can be found here:
  * [City of Philadelphia](https://www.phila.gov/programs/coronavirus-disease-2019-covid-19/testing/testing-data/)
  * [Erie County](https://ecdh.maps.arcgis.com/apps/dashboards/bf002f435cd94e65a4a7543dd7cb4168)
  * [Indiana Borough](https://www.indianaboro.com/news/categories/wastewater-surveillance)


###  [](https://forms.office.com/Pages/ResponsePage.aspx?id=QSiOQSgB1U2bbEf8Wpob3uikwdZKn-dMvUpB7wkOm9lUOTlTSTlYMDFOMFo5QVNSSEpUSFQyOE1TWS4u)**National Wastewater Surveillance Programs**
The Centers for Disease Control and Prevention (CDC) launched their National Wastewater Surveillance System (NWSS) in 2020. CDC NWSS coordinates and collects data from wastewater surveillance projects around the United States. CDC NWSS also conducts its own wastewater testing which includes some wastewater treatment facilities in Pennsylvania. CDC uses these data to conduct analyses and share reports. These data can be viewed on the [CDC NWSS website](https://www.cdc.gov/nwss/index.html).
Another national wastewater surveillance program that is testing Pennsylvania wastewater is wastewaterSCAN, led by Stanford University. Data collected through wastewaterSCAN can be viewed on the [wastewaterSCAN dashboard](https://data.wastewaterscan.org/).
**Connect with PaWSS**
For any questions or if you are interested in sharing data with PaWSS [connect with the PaWSS team](https://forms.office.com/Pages/ResponsePage.aspx?id=QSiOQSgB1U2bbEf8Wpob3uikwdZKn-dMvUpB7wkOm9lUOTlTSTlYMDFOMFo5QVNSSEpUSFQyOE1TWS4u).
Return to top 
...
--- EMBEDDED FILE CONTENT: https://www.pa.gov/content/dam/copapwp-pagov/en/health/documents/topics/documents/environmental-health/WSS%20Dashboard%20FAQ.pdf ---

Pennsylvania Wastewater Surveillance System (PaWSS) Dashboard Frequently Asked Questions (FAQs)
* * *
Dashboard Background Information What is the purpose of the PaWSS dashboard? The PaWSS dashboard shares information on the levels of genetic material of SARS-CoV-2 (the virus that causes COVID-19), influenza A, and RSV measured in wastewater samples collected across the Commonwealth. These data can help track disease trends in a community. Where does the data for the PaWSS dashboard come from? In many communities in the Commonwealth, wastewater treatment facilities collect samples of untreated wastewater for testing. These samples are then sent to the Pennsylvania Bureau of Laboratories (BOL) or a partner laboratory for analysis. Laboratories measure concentrations of traces of genetic material and share the results with the PaWSS team. How frequently is the PaWSS dashboard updated? The PaWSS dashboard is updated weekly on Monday mornings at 10am. Please note that the two most recent weeks of data are subject to change due to reporting delays. What is the WVAL? The wastewater viral activity level (WVAL) is a numerical metric created by the Centers for Disease Control and Prevention’s National Wastewater Surveillance System (CDC NWSS). The CDC measures WVALs for three diseases, SARS-CoV-2, RSV and Influenza A. The formula is: WVAL = e # of standard deviations relative to the baseline. For each virus, higher WVALs may suggest more disease spreading in a community. More information on WVALs can be found on CDC’s website.
* * *
What do the WVAL categories mean? WVAL is divided into five categories based on the numeric value: minimal, low, moderate, high, or very high. The WVAL values that represent each category are different for each virus and are determined by CDC NWSS. The categories represent the amount of virus present in wastewater compared to past data measured at that location. These categories may provide information about the amount of disease spreading in a community. Importantly, while the WVAL calculations are based on methods developed by CDC NWSS, the WVALs calculated by PaWSS may differ slightly from CDC’s due to small variations in the methods used for calculations.
* * *
How are SARS-CoV-2 variants detected in wastewater? SARS-CoV-2 variants are detected through whole genome sequencing of the genetic material found in wastewater samples. Data are available for sites that regularly send wastewater samples to laboratories that can conduct whole genome sequencing and for which sufficient SARS-CoV-2 concentrations are measured. Variant percentage data is population-weighted across all sampling locations in Pennsylvania with available data. Variants that make up less than 5% are grouped together and labeled as “Other.”
* * *
Dashboard Navigation How can I view data measured for each virus? Click the bottons at the bottom of the dashboard to see data for each virus included in the PaWSS dashboard. The percentages of SARS-CoV-2 variants measured in Pennsylvania wastewater can be viewed by selecting the “SARS-CoV-2 Variants” tab.
* * *
How can I view data measured from a particular sampling location? Select a sampling location from the list on the left side of the dashboard to see the plot for that site on the bottom right. This plot displays all WVAL measurements over time at that site. Select the site name again to return to the statewide view.
* * *
How can I view instructions in the dashboard? Brief dashboard navigation instructions can be viewed by clicking on the icon on each tab.
* * *
Dashboard Interpretation
* * *
What does the location on the map represent? The location of each dot on the map is not the exact location of the sampling location. Instead, each dot is mapped to the centroid of the zip code of the sampling location’s mailing address.
* * *
How does wastewater data correlate with reported cases of a disease? The WVAL is calculated from the concentrations of SARS-CoV-2, Influenza A, and RSV genetic material in wastewater over time. These concentrations have been correlated with case counts in communities across the United States and globally. However, the relationship between wastewater concentrations and case counts can vary depending on factors such as the type of virus or genetic material measured, whether people seek care for illness, inputs from non human sources, and other factors. For some viruses, concentrations in wastewater may increase before increases are measured in cases counts or hospitalizations.
* * *
What do each of the WVAL categories mean? The WVAL categories compare concentrations measured during the most recent sample collection date to the calculated baseline level for that site. This baseline level may change over time and calculations differ by pathogen. More information on how this baseline is calculated can be found on CDC’s website here: https://www.cdc.gov/nwss/about-data.html#data-method. Importantly while WVAL categories can provide some information on how much virus is
* * *
spreading in that area, compared to past data, local factors such as large events, changing populations (e.g., near universities), or rainfall can also affect WVAL. For this reason, the WVAL should be used in combination with clinical case data (for example, data available on PA DOH’s Respiratory Virus Dashboard) t o assess disease trends in a community. Additionally, the WVAL cannot provide information about individuals and should not replace clinical testing when individuals feel sick. Who can I reach out to if I have questions about wastewater surveillance in Pennsylvania? Please direct additional questions to our PaWSS email address: ra-dhpawss@pa.gov.
* * *

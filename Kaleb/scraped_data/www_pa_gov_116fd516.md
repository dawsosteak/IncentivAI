--- SOURCE: https://www.pa.gov/agencies/health/health-statistics/cancer-statistics/cancer-dashboard ---
...
[ Skip to agency navigation ](https://www.pa.gov/agencies/health/health-statistics/cancer-statistics/cancer-dashboard#agencynav)
[ Skip to main content ](https://www.pa.gov/agencies/health/health-statistics/cancer-statistics/cancer-dashboard#content)
...
##  [Department of Health](https://www.pa.gov/agencies/health)
  ...
  * [Dashboards ](https://www.pa.gov/agencies/health/dashboards)
  ...
  4. [ Cancer Statistics ](https://www.pa.gov/agencies/health/health-statistics/cancer-statistics)
  5. Cancer Dashboard
...
[ ![Logo for the Cancer Statistics Dashboard](https://s7d9.scene7.com/is/image/statepa/cancer-statistics-dashboard?ts=1773336376307&dpr=off) (opens in a new tab)](https://app.powerbigov.us/view?r=eyJrIjoiOTU5OGNjOTQtMGQ3OC00NjZmLThmMjYtMzEwZTEzNzUwMTI5IiwidCI6IjQxOGUyODQxLTAxMjgtNGRkNS05YjZjLTQ3ZmM1YTlhMWJkZSJ9)
[![](https://www.pa.gov/sites/health/topics/HealthStatistics/CancerStatistics/dashboard/PublishingImages/cancer-statistics-dashboard.png)Go to dashboard(opens in a new tab)](https://app.powerbigov.us/view?r=eyJrIjoiOTU5OGNjOTQtMGQ3OC00NjZmLThmMjYtMzEwZTEzNzUwMTI5IiwidCI6IjQxOGUyODQxLTAxMjgtNGRkNS05YjZjLTQ3ZmM1YTlhMWJkZSJ9)
...
## Help
The [Technical Notes(opens in a new tab)](https://www.pa.gov/en/agencies/health/health-statistics/cancer-statistics/cancer-dashboard/technical-notes) describe the data sources and methods used in the dashboard​.
To view the dashboard in full screen mode, click on the double arrow in the gray strip at the bottom right corner ![full screen mode](https://www.pa.gov/content/dam/copapwp-pagov/en/health/images/topics/healthstatistics/cancerstatistics/dashboard/publishingimages/power-bi-full-screen-button.png). Full screen mode will open in a new browser tab.
To view a larger rendering of an individual chart, click on the box that appears at the top right of the chart ![focus mode](https://www.pa.gov/content/dam/copapwp-pagov/en/health/images/topics/healthstatistics/cancerstatistics/dashboard/publishingimages/power-bi-focus-mode-button.png). You can access the data behind a chart by first right clicking within the chart and then selecting "Show Data".
## Resources
[Promotional Flyer](https://www.pa.gov/content/dam/copapwp-pagov/en/health/documents/topics/healthstatistics/cancerstatistics/dashboard/documents/current/Cancer%20Statistics%20Dashboard%20Promotional%20Flyer.pdf) (PDF)
Return to top 
...
--- EMBEDDED FILE CONTENT: https://www.pa.gov/content/dam/copapwp-pagov/en/health/documents/topics/healthstatistics/cancerstatistics/dashboard/documents/current/Cancer%20Statistics%20Dashboard%20Promotional%20Flyer.pdf ---

## Interactively examine trends in
**Incidence Mortality Survival Prevalence Lifetime Risk**
**Pennsylvanians**
incidence and mortality rates. 717.782.2448 An interactive tool for exploring different facets of cancer among http://bit.ly/2MIclpJ Introducing the www.doh.pa.gov/stats Division of Health Informatics 2018 Access detailed statistics for a cancer site by gender, race, year, age, stage and county. Download a large data file to further customize charts and views.
* * *

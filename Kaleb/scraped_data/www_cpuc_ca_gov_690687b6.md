--- SOURCE: https://www.cpuc.ca.gov/careers/apply-for-a-cpuc-job ---

[Skip to Main Content](https://www.cpuc.ca.gov/careers/apply-for-a-cpuc-job#main-content)
[ CA.gov ](http://www.ca.gov)
[Share via Facebook](https://www.cpuc.ca.gov/careers/apply-for-a-cpuc-job) [Share via Twitter](https://www.cpuc.ca.gov/careers/apply-for-a-cpuc-job) [Share via LinkedIn](https://www.cpuc.ca.gov/careers/apply-for-a-cpuc-job) Share via Email
...
SearchLoading
  ...
  3. [Apply for a Job Information](https://www.cpuc.ca.gov/careers/apply-for-a-cpuc-job)


#  How to apply for a state job
## IMPORTANT INFORMATION
##  How do I locate job openings at the CPUC? 
All current CPUC job opportunity bulletins are found [HERE](https://www.calcareers.ca.gov/CalHRPublic/Search/JobSearchResults.aspx#kw=Public%20Utilities%20Commission "Link to current CPUC Job opportunities")
...
Resources
[CalCareers Tutorial videos for Job Seekers](https://jobs.ca.gov/CalHrPublic/GeneralInfo/TutorialsMain.aspx "Link to CalCareers Website for Tutorial videos for Job Seekers")
...
##  How do I set up a My CalCareers Profile for Job Seekers? 
If you do not already have a CalCareer Account, please create a new account by clicking on the following link: ["Create Account"](https://www.calcareers.ca.gov/CalHRPublic/CreateNewAccount.aspx "This is a link to CalHR MyCalCareer create an account") . 
Getting a job with the State of California is now simpler than ever. 
Start by creating a CalCareer account. 
With an account, 
  1. you can take state civil service examinations, 
  2. store different versions of your application, 
  3. track your application status and 
  4. save your resume all in one place.
...
Click the [“Create account”](https://www.calcareers.ca.gov/CalHRPublic/CreateNewAccount.aspx "Link to CalCareers website to create an account") link now to get started on the CalCareer website.
...
**Planning**
  1. Read the entire job advertisement.
  2. Review and consider each question or desirable qualification that is listed in the job posting.
  3. Refrain from regurgitating what is on your resume.
  4. Allow yourself enough time to complete the required document(s) to eliminate room for errors.
  5. Do not sell yourself short on your experience.


**Writing**
  1. Clearly define your experience and how it aligns to the duty statement.
  2. There is not one perfect way to write a SOQ, but the best advice is to make it unique to you.
  3. Remember that grammar, clarity of expression, and legibility are considered in the evaluation process.
  4. If a question doesn’t pertain to you, write in the most closely related answer possible to showcase your transferable skills.
  5. Be specific when answering questions regarding your experience (where, when, what, how, and why).
  6. Provide specific examples that demonstrate your qualifications.
  7. If the question has multiple parts (A, B, and C), answer each part separately.
  8. Address each question/desirable qualification described in the recruitment individually.


**Reviewing**
  1. Ensure you address all questions/desirable qualifications.
  2. Ensure you follow all SOQ instructions regarding font, font size and number of pages. 
...
[Flex Alert](https://www.flexalert.org/)
  * [Back to Top](https://www.cpuc.ca.gov/careers/apply-for-a-cpuc-job#skip-to-content)

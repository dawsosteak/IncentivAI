--- SOURCE: https://www.cpuc.ca.gov/industries-and-topics/electrical-energy/electric-rates/rate-change-advisories ---

[Skip to Main Content](https://www.cpuc.ca.gov/industries-and-topics/electrical-energy/electric-rates/rate-change-advisories#main-content)
[ CA.gov ](http://www.ca.gov)
[Share via Facebook](https://www.cpuc.ca.gov/industries-and-topics/electrical-energy/electric-rates/rate-change-advisories) [Share via Twitter](https://www.cpuc.ca.gov/industries-and-topics/electrical-energy/electric-rates/rate-change-advisories) [Share via LinkedIn](https://www.cpuc.ca.gov/industries-and-topics/electrical-energy/electric-rates/rate-change-advisories) Share via Email
...
Site Search
  ...
  5. [Rate Change Advisories](https://www.cpuc.ca.gov/industries-and-topics/electrical-energy/electric-rates/rate-change-advisories)


#  Rate Change Advisories
Throughout the year, electric and gas utilities submit requests to the California Public Utilities Commission (CPUC) to change rates. These rate changes, also called tariff changes, reflect the implementation of previously authorized CPUC orders (including decisions, resolutions, or advice letters). Each rate change can reflect the implementation of one or more prior CPUC orders. A rate change that reflects multiple orders is often referred to as a consolidated rate and tariff change. 
Rate Advisory (or rate alert) notices can be found on the respective utility websites. These notices are produced by the utilities at the direction of the CPUC to provide transparency for customers about electric and gas rates.
**Current Rate Advisories (2024 thru Present)**
[PG&E Rate Advisory](https://www.pge.com/en/account/rate-plans/rate-advisories.html)   
[SCE Rate Advisory](https://www.sce.com/save-money/rates-financing/sce-rate-advisory%20)   
[SDG&E Rate Alert](https://www.sdge.com/rate-alerts)   
[SoCalGas Rate Alert](https://www.socalgas.com/billing-payment/understanding-my-bill/natural-gas-rate-alerts)
**Rate Advisories Prior to 2023**
Rate Change Alerts from 2023 and previous years were developed by the CPUC internally; these historic rate change alerts can be found [here](https://www.cpuc.ca.gov/industries-and-topics/electrical-energy/electric-rates/rate-change-advisories/rate-change-alerts---previous-years).
##  Rate Change Advisories
  * [Rate Change Alerts - Previous Years](https://www.cpuc.ca.gov/industries-and-topics/electrical-energy/electric-rates/rate-change-advisories/rate-change-alerts---previous-years)
...
[Flex Alert](https://www.flexalert.org/)
  * [Back to Top](https://www.cpuc.ca.gov/industries-and-topics/electrical-energy/electric-rates/rate-change-advisories#skip-to-content)

--- SOURCE: https://www.cpuc.ca.gov/proceedings-and-rulemaking/alternative-dispute-resolution/commonly-asked-questions ---

[Skip to Main Content](https://www.cpuc.ca.gov/proceedings-and-rulemaking/alternative-dispute-resolution/commonly-asked-questions#main-content)
[ CA.gov ](http://www.ca.gov)
[Share via Facebook](https://www.cpuc.ca.gov/proceedings-and-rulemaking/alternative-dispute-resolution/commonly-asked-questions) [Share via Twitter](https://www.cpuc.ca.gov/proceedings-and-rulemaking/alternative-dispute-resolution/commonly-asked-questions) [Share via LinkedIn](https://www.cpuc.ca.gov/proceedings-and-rulemaking/alternative-dispute-resolution/commonly-asked-questions) Share via Email
...
SearchLoading
  ...
  3. [Alternative Dispute Resolution (ADR) Program](https://www.cpuc.ca.gov/proceedings-and-rulemaking/alternative-dispute-resolution)
  4. [Common Questions About ADR](https://www.cpuc.ca.gov/proceedings-and-rulemaking/alternative-dispute-resolution/commonly-asked-questions)


#  Common Questions About ADR
**What is****ADR?** ADR commonly describes processes, such as facilitation, negotiation, mediation, and early neutral evaluation (or a combination of those techniques), to help disputants resolve a conflict without a formal decision by a court or agency. ADR tries to identify and meet the underlying interests of the parties in the dispute. When successful, ADR may achieve results that a court or agency may not be able to order, give the parties more ownership in the result, and reduce litigation and agency costs.
**Who**  
**  
What type of disputes may be submitted to ADR?** ADR is generally available to resolve disputes in formal proceedings pending before the CPUC. Occasionally, ADR is provided for other disputes if the disagreement is likely to be filed as a formal proceeding.  
  
**How much does ADR cost?** The CPUC's ADR services are provided at **no cost** to the parties.  
  
**What are the advantages & disadvantages of ADR?** Because ADR focuses on the parties' basic interests, a dispute may be settled on terms more tailored and favorable to each of the parties. Since the process is voluntary, free, and normally confidential, parties have little "down-side" risk in trying ADR. ADR may save time and litigation expenses. Even if a complete settlement is not possible, agreement may be reached on some important points. However, ADR may require the parties to spend more time on a proceeding, and that time may be lost if a complete or partial agreement is not reached.  
**  
When is ADR available?** Normally, ADR requests should be made early in a formal proceeding. However, ADR may also be requested at any time in a formal proceeding if parties believe ADR will assist in promptly resolving the dispute. ADR also may be available for disputes that are likely to be filed as formal proceedings before the CPUC. ADR is available to assist parties in their discovery disputes or other distinct disputes which may help advance or streamline a formal proceeding.  
  
**What types of ADR are available?** The CPUC's ADR program provides facilitation, mediation, early neutral evaluation (ENE), and settlement judge services. The most commonly used ADR process uses some combination of the foregoing techniques to assist the parties in reaching a settlement, when possible.  
**  
What happens during ADR?** Use this [LINK](https://ia.cpuc.ca.gov/form/page.aspx?id=27) to access a more detailed description of what happens during ADR.  
  
**What does it mean that ADR is usually confidential?** Although parties can agree to negotiate in public, most ADR processes are confidential. This means that all participating parties, including the ALJ neutral, promise not to reveal what was said in ADR sessions. Confidentiality allows the parties to be candid with one another and to explore settlement possibilities that could not be discussed or used in public or any subsequent legal or administrative proceeding. The parties may agree that a written agreement resulting from ADR may be public. If the agreement requires CPUC approval, all or part of the agreement may need to be public.  
...
**How is ADR being conducted at this time?** Until further notice, all ADRs are conducted remotely using virtual meeting platforms with breakout session capability such as WebEx or telephonically.  
  
**How can I request ADR?** There are three ways to request an ADR:
1. Simply follow this [LINK](https://www.cpuc.ca.gov/proceedings-and-rulemaking/alternative-dispute-resolution/request-for-alternative-dispute-resolution) and fill out the web-based ADR Request Form.
2. Send an e-mail to ADR_Program@cpuc.ca.gov.
3. Finally, you can contact the ADR Coordinator, James Donovan at (415-703-1971).
Please include your name, telephone number, e-mail address, the formal proceeding number (if any), and a brief description of the dispute. Normally, requests should be made early in a formal proceeding.
ADR may also be requested at any time in a formal proceeding if parties believe ADR will assist in promptly resolving the dispute.
##  How can we help?
Emergency? **Call 911**  
...
[Flex Alert](https://www.flexalert.org/)
  * [Back to Top](https://www.cpuc.ca.gov/proceedings-and-rulemaking/alternative-dispute-resolution/commonly-asked-questions#skip-to-content)

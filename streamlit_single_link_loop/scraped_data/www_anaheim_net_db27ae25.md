--- SOURCE: https://www.anaheim.net/6473/Commercial-Recycling-Organic-Waste-Waive ---

![Loading](https://www.anaheim.net/Common/images/ajax-loader.gif)
Loading
[Skip to Main Content](https://www.anaheim.net/6473/Commercial-Recycling-Organic-Waste-Waive#cc622007e8-e6c7-4d3b-8aef-85364de4b3e8)
...
[![Go to Site Search](https://www.anaheim.net/ImageRepository/Document?documentID=41694)](https://www.anaheim.net/Search/Results) Search
  ...
  * [ ![Newsletter](https://www.anaheim.net/ImageRepository/Document?documentID=41697) ](https://www.anaheim.net/list.aspx)
  ...
  6. [Solid Waste & Recycling](https://www.anaheim.net/474/Solid-Waste-Recycling)
  7. [Organic waste](https://www.anaheim.net/6048/Organic-waste)
  8. [Commercial Recycling & Organic Waste Waiver](https://www.anaheim.net/6473/Commercial-Recycling-Organic-Waste-Waive)


#  Commercial Recycling & Organic Waste Waiver 
![recycling and organics waiver header](https://www.anaheim.net/ImageRepository/Document?documentID=51720)
Many Anaheim residents and businesses are already implementing the city's new organic waste recycling program in their homes and kitchens. The program kicked off in July 2023 following state requirements to reduce greenhouse gas emissions from landfills. Learn more about the organic waste recycling program [here](https://www.anaheim.net/6048/Organic-waste).
...
## Amount of waste or recycling generated
  * Commercial businesses that generate a minimal amount of organic waste or recyclables based on the following:
    * Total trash collection (trash, recycle and organic waste combined) is **2 cubic yard****s or more of service per week** and total recyclable and organic waste generated is **less than 20 gallons per week**
    * Total trash collection (trash, recycle and organic waste combined) is **less than****2 cubic yard****s of service per week** and total recyclable and organic waste generated is **less than 10 gallons per week**
...
_Note: the smallest container size available is 35-gallons; recycling and trash split collection bins are available upon approval by Republic Services _
[![Waiver application button Opens in new window](https://www.anaheim.net/ImageRepository/Document?documentId=51896)](https://www.anaheim.net/FormCenter/Public-Works-5/Commercial-Recycling-Organics-Waiver-App-322)
After the application is completed, you may be contacted by the city, a representative or Republic Services to schedule a site visit. If approved, the wavier is valid for up to **five years**. 
## Waiver Holder Requirements
  * Must cooperate with the city and Republic Services for compliance inspections
  * Must notify anaheimrecycles@republicservices.com if circumstances change that impact waiver eligibility, re-evaluation may be required
...
For more details regarding waiver requirements click [here](https://codelibrary.amlegal.com/codes/anaheim/latest/anaheim_ca/0-0-0-80179)
